...
export const PROFILE_FIELDS: ProfileField[] = [
    ...
    },
    {
        ...
        type: 'select',
        value: '',
        options: ['Для работы', 'Для путешествий', 'Для себя', 'Для экзамена'],
    },
    {
        name: 'interests',
        label: 'Интересы',
        type: 'checkbox',
        value: [],
        options: ['IT', 'Музыка', 'Спорт', 'Кино', 'Книги'],
    },
    {
        name: 'studyTime',
...

    {
        ...
        type: 'radio',
        value: '',
        options: ['Не женат/Не замужем', 'Женат/Замужем', 'В разводе'],
    },
    {
        name: 'spouseName',
        label: 'Имя супруга',
        type: 'text',
        value: '',
        visibleWhen: { field: 'maritalStatus', value: 'Женат/Замужем' },
    },
    {
        name: 'maidenName',
        ...
        type: 'text',
        value: '',
        disabledWhen: { field: 'maritalStatus', value: 'Женат/Замужем' },
        valueWhenDisabled: 'не применимо',
    },
    { name: 'bio', label: 'О себе', type: 'textarea', value: '' },
    { name: 'notes', label: 'Заметки', type: 'textarea', value: '' },
    {
        name: 'dailyGoal',
        label: 'Цель в день (слов)',
        type: 'number',
        value: 10,
    },
